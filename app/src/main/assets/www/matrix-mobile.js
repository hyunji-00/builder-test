 ...
 * @description     Matrix Mobile Plugin Javascript wrapping 객체로 app,misc,camera 등 플러그인객체에 property와 API를 제공한다.
 */
if (typeof $h !== "object") {
    $h = {};
}
...
$h.exec = function(callback, service, method, params){
    if(typeof matrixMobile === "object"){
        matrixMobile.exec(callback,service,method,params);
    } else {
        console.log("not found matrixMobile");
    }
}
...
$h.dismissScreen = function () {
    if (typeof window.webkit == "undefined") {
        matrixBridge.dismissLoadingLayout();
    } else {
        webkit.messageHandlers.matrixMobile.postMessage(["MatrixMobile","dismissScrean"]);
    }
}
...
$h.app.finish = function (callback, options) {
    try {
        matrixMobile.plugin.app.finish(callback, options);
    } catch (e) {
        console.log(e);
    }
}
 ...
 * @description   matrixMobile app에 version 정보를 callback에 param으로 반환한다.
 * @param         {Function} callback - 콜백함수
 * @param         {String} callback.statusCode - 코드
 * @param         {String} callback.msg - 메시지
...
$h.app.version = function (callback) {
    try {
        matrixMobile.plugin.app.version(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.app.checkAppInstalled = function (callback, options) {
    try {
        matrixMobile.plugin.app.checkAppInstalled(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.screen.startWebview = function (callback, options) {
    try {
        matrixMobile.plugin.screen.startWebView(callback, options);
    } catch(e) {
        console.log(e);
    }
}
...
$h.screen.closeSubWebview = function (callback) {
    try {
        matrixMobile.plugin.screen.closeSubWebView(callback);
    } catch(e) {
        console.log(e);
    }
}
...
$h.screen.screenCapture = function (callback, options) {
    try {
        matrixMobile.plugin.screen.screenCapture(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.screen.screenOrientation = function (callback, options) {
    try {
        matrixMobile.plugin.screen.screenOrientation(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.screen.setupBrightness = function (callback, params) {
    try {
        matrixMobile.plugin.screen.setupBrightness(callback, params)
    } catch (e) {
        console.log(e);
    }
}
 ...
 * @description   matrixMobile storage 엔진,리소스,db,cache 및 모든 설정을 reset한다.
 * @param         {Function} callback - 콜백함수
 * @param         {String} callback.statusCode - 코드
 * @param         {String} callback.msg - 메시지
 * @param         {String} callback.data - 데이터
...
$h.storage.reset = function (callback, options) {
    try {
        matrixMobile.plugin.storage.reset(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.storage.setPreference = function (callback, options) {
    try {
        matrixMobile.plugin.storage.setPreference(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.storage.getPreference = function (callback, options) {
    try {
        matrixMobile.plugin.storage.getPreference(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.storage.removePreference = function (callback, options) {
    try {
        matrixMobile.plugin.storage.removePreference(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.storage.shareData = function (callback, options) {
    try {
        matrixMobile.plugin.storage.shareData(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.log.getLog = function (callback, options) {
    try {
        matrixMobile.plugin.log.getLog(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.log.getLogUpload = function (callback, options) {
    try {
        matrixMobile.plugin.log.getLogUpload(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.log.getLogMail = function (callback, options) {
    try {
        matrixMobile.plugin.log.getLogMail(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.log.clearLog = function (callback) {
    try {
        matrixMobile.plugin.log.clearLog(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.log.logPath = function (callback, options) {
    try {
        matrixMobile.plugin.log.logPath(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.speech.speakTTS = function (callback, options) {
    try {
        matrixMobile.plugin.speech.speakTTS(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.speech.stopTTS = function (callback) {
    try {
        matrixMobile.plugin.speech.stopTTS(callback);
    } catch (e) {
        console.log(e);
    }
}
...
*/
$h.speech.startSpeechToText = function (callback, option) {
    try {
        matrixMobile.plugin.speech.startSpeechToText(callback, option);
    } catch (e) {
        console.log(e);
    }
}
...
$h.speech.stopSpeechToText = function (callback) {
    try {
        matrixMobile.plugin.speech.stopSpeechToText(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.audioRecorder.recordAudio = function (callback, options) {
    try {
        matrixMobile.plugin.audioRecorder.recordAudio(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.audioRecorder.recordFinish = function (callback) {
    try {
        matrixMobile.plugin.audioRecorder.recordFinish(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.audioRecorder.recordCancel = function (callback) {
    try {
        matrixMobile.plugin.audioRecorder.recordCancel(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.audioRecorder.recordPause = function (callback) {
    try {
        matrixMobile.plugin.audioRecorder.recordPause(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.audioRecorder.recordResume = function (callback) {
    try {
        matrixMobile.plugin.audioRecorder.recordResume(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.audioRecorder.recordStatus = function (callback) {
    try {
        matrixMobile.plugin.audioRecorder.recordStatus(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.audioRecorder.deleteAudioFile = function (callback, data) {
    try {
        matrixMobile.plugin.audioRecorder.deleteAudioFile(callback, data);
    } catch (e) {
        console.log(e);
    }
}
...
$h.audioRecorder.deleteAllFile = function (callback) {
    try {
        matrixMobile.plugin.audioRecorder.deleteAllFile(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.barcodeMLKit.startBarcodeScanner = function (callback, options) {
    try {
        matrixMobile.plugin.barcodescannermlkit.startBarcodeScanner(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.barcodeMLKit.closeBarcodeScanner = function (callback) {
    try {
        matrixMobile.plugin.barcodescannermlkit.closeBarcodeScanner(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.barcodeMLKit.galleryBarcodeScanner = function (callback) {
    try {
        matrixMobile.plugin.barcodescannermlkit.galleryBarcodeScanner(callback);
    } catch(e) {
        console.log(e);
    }
}
...
$h.barcodeMLKit.flashlightBarcodeScanner = function (callback, option) {
    try {
        matrixMobile.plugin.barcodescannermlkit.flashlightBarcodeScanner(callback, option);
    } catch (e) {
        console.log(e);
    }
}
...
$h.barcodeMLKit.barcodeScannerStatus = function (callback) {
    try {
        matrixMobile.plugin.barcodescannermlkit.barcodeScannerStatus(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.biometric.deleteData = function (callback, options) {
    try {
        matrixMobile.plugin.biometric.deleteData(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.biometric.checkData = function (callback, options) {
    try {
        matrixMobile.plugin.biometric.checkData(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.biometric.encryptData = function (callback, options) {
    try {
        matrixMobile.plugin.biometric.encryptData(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.biometric.decryptData = function (callback, options) {
    try {
        matrixMobile.plugin.biometric.decryptData(callback, options);
    } catch (e) {
        console.log(e);
    }
}
 ...
 * @param         {Int} options.type - 반환타입 (0: base64 String, 1 : file URL String(default))
 * @example
...
$h.contents.filePicker = function (callback, options) {
    try {
        matrixMobile.plugin.contents.filePicker(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.contents.imagePicker = function (callback, options) {
    try {
        matrixMobile.plugin.contents.imagePicker(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.contents.fileDownload = function (callback, options) {
    try {
        matrixMobile.plugin.contents.fileDownload(callback, options);
    } catch (e) {
        console.log(e);
    }
}
 ...
 * @description   device battery level (Android Only)
 * @param         {Function} callback - 콜백함수
 * @example
 * var callback = function(result){ console.log(result); };
 ...
 * @description   현재 배터리가 충전 상태인지 확인 (Android Only)
 * @param         {Function} callback - 콜백함수
 * @example
 * var callback = function(result){ console.log(result); };
 ...
 * @description   배터리 상태 확인 receiver register (Android Only)
 * @param         {Function} callback - 콜백함수
 * @example
 * var callback = function(result){ console.log(result); };
 ...
 * @description   배터리 상태 확인 receiver unregister (Android Only)
 * @param         {Function} callback - 콜백함수
 * @example
 * var callback = function(result){ console.log(result); };
 ...
 * @param          {String} removePercentEncoding - percentEncoding 제거 여부 (iOS Only)
 * @param          {String} isInspectEnable - inspector 활성화 여부 (iOS Only)
 * @example
 * $h.inappbrowser.open("https://www.inswave.com","_system", "", true, true);
 */
$h.inappbrowser.open = function (url,type,option, removePercentEncoding, isInspectEnable) {
    var iab = null;
    try {
        if (typeof matrixMobile.plugin.InAppBrowser === "object") {
            iab = matrixMobile.plugin.InAppBrowser.open(url, type, option, removePercentEncoding, isInspectEnable);
        }
        return iab;
    } catch (e) {
        console.log(e);
 ...
 * @description   matrixMobile에서 사용된 open source license를 출력한다. license파일에 내용을 추가하여 출력이 가능하다.
 * @param         {Function} callback - 콜백함수
 * @param         {String} callback.statusCode - 코드
 * @param         {String} callback.msg - 메시지
 * @param         {Object} callback.data - 데이터
...
$h.license.showView = function (callback) {
    try {
        matrixMobile.plugin.license.showView(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.sendCall = function (callback, options) {
    try {
        matrixMobile.plugin.misc.sendCall(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.sendSMS = function (callback, options) {
    try {
        matrixMobile.plugin.misc.sendSMS(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.getContacts = function (callback) {
    try {
        matrixMobile.plugin.misc.getContacts(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.openBrowser = function (callback, options) {
    try {
        matrixMobile.plugin.misc.openBrowser(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.settingStatus = function (callback, options) {
    try {
        matrixMobile.plugin.misc.settingStatus(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.startTimer = function (callback, options) {
    try {
        matrixMobile.plugin.misc.startTimer(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.stopTimer = function (callback, options) {
    try {
        matrixMobile.plugin.misc.stopTimer(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.stopTimerAll = function (callback) {
    try {
        matrixMobile.plugin.misc.stopTimerAll(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.misc.getServerIp = function (callback) {
    try {
        matrixMobile.plugin.misc.getServerIp(callback);
    } catch (e) {
        console.log(e);
    }
}
 ...
 * @description    현재 연결되어 있는 Wi-Fi 의 ssid(name) 반환 (Android Only)
 * @example
 * var callback = function(result){ console.log((result)); };
...
$h.paint.openPaint = function(callback, opt) {
    try{
        matrixMobile.plugin.paint.openPaint(callback, opt);
    } catch(e){
        console.log(e);
    }
}
...
$h.screenRecorder.recordScreen = function (callback, options) {
    try {
        matrixMobile.plugin.screenRecorder.recordScreen(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.screenRecorder.recordFinish = function (callback) {
    try {
        matrixMobile.plugin.screenRecorder.recordFinish(callback);
    } catch (e) {
        console.log(e);
    }
}
...
$h.screenRecorder.recordCancel = function (callback) {
    try {
        matrixMobile.plugin.screenRecorder.recordCancel(callback)
    } catch (e) {
        console.log(e)
    }
}
...
$h.screenRecorder.recordPause = function (callback) {
    try {
        matrixMobile.plugin.screenRecorder.recordPause(callback)
    } catch (e) {
        console.log(e)
    }
}
...
$h.screenRecorder.recordResume = function (callback) {
    try {
        matrixMobile.plugin.screenRecorder.recordResume(callback)
    } catch (e) {
        console.log(e)
    }
}
...
$h.screenRecorder.recordStatus = function (callback) {
    try {
        matrixMobile.plugin.screenRecorder.recordStatus(callback)
    } catch (e) {
        console.log(e)
    }
}
...
$h.screenRecorder.deleteFile = function (callback, options) {
    try {
        matrixMobile.plugin.screenRecorder.deleteFile(callback, options)
    } catch (e) {
        console.log(e)
    }
}
...
$h.screenRecorder.deleteAllFile = function (callback, options) {
    try {
        matrixMobile.plugin.screenRecorder.deleteAllFile(callback, options)
    } catch (e) {
        console.log(e)
    }
}
...
$h.view.toast = function (callback, options) {
    try {
        matrixMobile.plugin.view.toast(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.view.snackBar = function (callback, options) {
    try {
        matrixMobile.plugin.view.snackBar(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.view.notification = function (callback, options) {
    try {
        matrixMobile.plugin.view.notification(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.websquare.excelDownload = function (success, fail, option) {
    try {
        matrixMobile.plugin.websquare.excelDownload(success, fail, option);
    } catch (e) {
        console.log(e);
    }
}
...
$h.inAppUpdate.checkOffline = function (callback) {
    matrixMobile.exec(callback, "InAppUpdatePlugin", "isOffline", []);
}
...
$h.inAppUpdate.checkRefreshUpdate = function (callback, options) {
    matrixMobile.exec(callback, "InAppUpdatePlugin", "checkRefreshUpdate", options);
}

/**
 * function       $h.inAppUpdate.showServerSelect
 * description    Server Select 화면을 보여준다.
 *                 서버를 선택하면 matrixMobileSdk.init() 부터 다시 시작할 수 있도록 Native 에서 처리가 필요하다.
 * example
 * var callback = function(e){console.log(e);};
 * $h.inAppUpdate.showServerSelect(callback);
 */
$h.inAppUpdate.showServerSelect = function (callback) {
    matrixMobile.exec(callback, "InAppUpdatePlugin", "showServerSelect", {});
}
...
$h.screenprotector.start = function(callback) {
    try {
        matrixMobile.plugin.screenprotector.start(callback);
    } catch(e) {
        console.log(e);
    }
}
...
$h.screenprotector.stop = function(callback) {
    try {
        matrixMobile.plugin.screenprotector.stop(callback);
    } catch(e) {
        console.log(e);
    }
}
...
$h.edgeagent.userLogIn = function (callback, options) {
    try {
        matrixMobile.plugin.edgeagent.userLogIn(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.edgeagent.userLogOut = function (callback, options) {
    try {
        matrixMobile.plugin.edgeagent.userLogOut(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.edgeagent.getNewNotification = function (callback, options) {
    try {
        matrixMobile.plugin.edgeagent.getNewNotification(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.edgeagent.getAllNotification = function (callback, options) {
    try {
        matrixMobile.plugin.edgeagent.getAllNotification(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.edgeagent.setNotificationRead = function (callback, options) {
    try {
        matrixMobile.plugin.edgeagent.setNotificationRead(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
/**
 * @function      $h.edgeagent.onEventListener
 * @description   user 이벤트가 수신되었을때 호출될 함수를 등록한다.
 * @param         {Function} listener - user 이벤트발생시 실행할 함수
 * @example
 * var listener = function(e){ console.log(e); };
 * $h.edgeagent.onEventListener(listener);
 */
$h.edgeagent.onEventListener = function (listener) {
    try {
        document.addEventListener('onEdgeManagerEvent', listener, false);
    } catch (e) {
        console.log(e);
    }
}

// event      $h.edgeagent.onEventReceived
// description   EdgeManager user Event를 받았을때 Event를 발생시킨다. (App에서 호출)
$h.edgeagent.onEventReceived = function (data) {
    var event = new Event('onEdgeManagerEvent');
    event.data = data
    document.dispatchEvent(event);
}

/**
 * @function      $h.edgeagent.getUserList
 * @description   사용자 리스트를 가져온다.
 * @param         {Function} callback - 콜백함수<br/>콜백 파라미터
 * statusCode - {String} 1000
 * msg - {String} Success
 * data - {Object} null
 * @param         {Object} options - object
 *  * connectedOnly : 접속된 사용자 리스트만 가져올지 여부 (default : false)
 * @example
 * var callback = function(result){ console.log(result); };
 * var params = {"connectedOnly" : true} ;
 * $h.edgeagent.getUserList(callback,params);
 */
$h.edgeagent.getUserList = function (callback, options) {
    try {
        matrixMobile.plugin.edgeagent.getUserList(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
/**
 * @function      $h.edgeagent.getDeviceList
 * @description   Device 리스트를 가져온다.
 * @param         {Function} callback - 콜백함수<br/>콜백 파라미터
 * statusCode - {String} 1000
 * msg - {String} Success
 * data - {Object} null
 * @param         {Object} options - object
 *  * deptCode : 부서 코드 (비어있으면 모든 부서 선택)
 *  * deviceType : 디바이스 종류 Array (ex. pinpad, passbook 등)
 * @example
 * var callback = function(result){ console.log(result); };
 * var params = {"deptCode" : "122", "deviceType" : ["pinpad", "passbook"]} ;
 * $h.edgeagent.getDeviceList(callback,params);
 */
$h.edgeagent.getDeviceList = function (callback, options) {
    try {
        matrixMobile.plugin.edgeagent.getDeviceList(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
/**
 * @function      $h.edgeagent.sendMessage
 * @description   특정 사용자(들)에게 메세지를 전달한다.
 * @param         {Function} callback - 콜백함수<br/>콜백 파라미터
 * statusCode - {String} 1000
 * msg - {String} Success
 * data - {Object} null
 ...
 * @example
 * var callback = function(result){ console.log(result); };
 * var params = {"data" : {"test" : "test123"}, "receivers" : ["edgeID1", "edgeID2"]} ;
 * $h.edgeagent.sendMessage(callback,params);
 */
$h.edgeagent.sendMessage = function (callback, options) {
    try {
        matrixMobile.plugin.edgeagent.sendMessage(callback, options);
    } catch (e) {
        console.log(e);
    }
}
...
$h.debugging.setWebInspector = function (callback) {
    matrixMobile.exec(callback, "MatrixMobileDebuggingPlugin", "setWebInspector", []);
}
...
$h.debugging.showFileList = function (callback) {
    matrixMobile.exec(callback, "MatrixMobileDebuggingPlugin", "showFileList", []);
}
...
* @param         {String} option.model          matrixMobile.plugin.gemini.model 의 상수를 이용하거나, 신규 gemini 모델이 나오면 해당 모델명으로 설정한다.
...
* let option = {}
* option.apiKey = ""
* option.model = matrixMobile.plugin.gemini.model.gemini_1_5_flash
...
$h.gemini.init = function (callback, options) {
    try {
        matrixMobile.plugin.gemini.init(callback, options)
    } catch(e) {
        console.log(e);
    }
}
...
$h.gemini.generateContent = function (callback, options) {
    try {
        matrixMobile.plugin.gemini.generateContent(callback, options)
    } catch(e) {
        console.log(e);
    }
}
...
$h.gemini.imagePrompting = function (callback, options) {
    try {
        matrixMobile.plugin.gemini.imagePrompting(callback, options)
    } catch(e) {
        console.log(e);
    }
}
...
$h.gemini.responseStream = function (callback, options) {
    try {
        matrixMobile.plugin.gemini.responseStream(callback, options)
    } catch(e) {
        console.log(e);
    }
}
...
$h.gemini.initChat = function (callback, options) {
    try {
        matrixMobile.plugin.gemini.initChat(callback, options)
    } catch(e) {
        console.log(e);
    }
}
...
* @param         {Object} callback.data - 생성 된 content data.
* @example
* let chat = "swift 코드를 작성해야 하는데 뭐부터 해야할까?"
* $h.gemini.chat(callback, chat);
*/
$h.gemini.chat = function (callback, options) {
    try {
        matrixMobile.plugin.gemini.chat(callback, options)
    } catch(e) {
        console.log(e);
    }
}
...
$h.gemini.clearChatHistory = function (callback, options) {
    try {
        matrixMobile.plugin.gemini.clearChatHistory(callback, options)
    } catch(e) {
        console.log(e);
    }
}
...
$h.fcm.getToken = function(callback) {
    try {
        matrixMobile.plugin.fcm.getToken(callback);
    } catch (e) {
      console.log(e);
    }
}